...
class Records with ChangeNotifier {
  List<Record> records = [];
  static String recordListKey = 'record_list';
  final int limit;
  ...
  Future<void> persist() async {
    ...
    await global.prefs.setString(recordListKey, recordListStr);
  }

  static Records load() {
    String recordListStr = global.prefs.getString(recordListKey);
    List<Record> records = [];
